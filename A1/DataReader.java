...
//The assignment3.DataReader class deals with I/O of the dataset and serialized decision tree objects. It also
//splits the read dataset into training and test sets.
public class DataReader {

    //assignment3.Datum temp;
    ...
    void read_data(String filename) throws Exception
    {
        ...
        while (line!=null)
        {
            ...
            int jj = Math.round(f);
            //create a new assignment3.Datum object using the information read from the csv file
    ...
    // given a assignment3.DecisionTree object and a string, this method stores the given assignment3.DecisionTree object
    ...
    //given a filename as a string, this method returns the serialized assignment3.DecisionTree object present in the given filename
